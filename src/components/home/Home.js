...
function Home() {
  ...
  const settingsForNews = {
    ...
    speed: 1000,
    autoplay: true,
    slidesToShow: doctors.length <= 3 ? doctors.length : 3,
    slidesToScroll: doctors.length <= 3 ? doctors.length : 3,
    initialSlide: 1,
    responsive: [
      {
        breakpoint: 1024,
      ...
      },
      {
        breakpoint: 600,
        settings: {
          slidesToShow: doctors.length < 2 ? doctors.length : 2,
          slidesToScroll: doctors.length < 2 ? doctors.length : 2,
          initialSlide: doctors.length < 2 ? doctors.length : 2,
        },
      },
      {
        breakpoint: 480,
      ...
      <div className="home">
        ...
        <div className="home-box">
          <div className="left-site">
            <div
              ...
              style={
                i18next.language === "ru" ? { fontSize: 52 } : { fontSize: 67 }
              }
            >
              <span
                style={
            ...
            <div
              style={
                i18next.language === "ru" ? { fontSize: 20 } : { fontSize: 24 }
              }
        ...
        <div className="about-us-box">
          {aboutUs.map((item, index) => {
            return (
              <div key={index} className="mirror-sloy">
                <div className="sides">
                ...
                <div className="sides">
                  <div className="leaders-title">
                    <div className="title-leader">{t("aboutus")}</div>
                    <div className="line-text"></div>
                  </div>
                  <div className="main-text">{item.description}</div>
        ...
        <div className="leaders">
          <div className="leaders-title">
            <div className="title-leader">{t("leaders")}</div>
            <div className="line-text"></div>
          </div>
          ...
          <div className="leaders-container">
            <Slider {...settingsForNews}>
              {doctors.length > 0 &&
                doctors
                  .filter((item) => item.user_type == "Head")
                  .map((item, index) => {
                    return (
                      <div
                        key={index}
        ...
        <div className="teachers">
          <div className="teachers-title">
            <div className="title-teacher">{t("teachers")}</div>
            <div className="line-text"></div>
          </div>
        ...
        <div className="Events">
          <div className="Events-title">
            <div className="title-Events">{t("news")}</div>
            <div className="line-text"></div>
          </div>
                          ...
                          {item.image_set ? (
                            ...
                            <Slider {...settingsForNews2}>
                              {item.image_set.map((item, index) => {
                                return (
                                  <div key={index} className="click-slide-box">
                          ...
                          <div className="name-box">
                            <div className="name-Events">
                              <div className="content1">
                                <div className="events-name">{item.title}</div>
